...
public class DBWorkload {
    ...
    public static void main(String[] args) throws Exception {
        // Initialize log4j
        String loggingConfigFile = "D:\\workspace\\oltp\\log4j.properties";

        String log4jPath = System.getProperty("log4j.configuration", loggingConfigFile);
        if (log4jPath != null) {
    ...
    private static Results runWorkload(List<BenchmarkModule> benchList, boolean verbose, int intervalMonitor) throws QueueLimitException, IOException {
        ...
        for (BenchmarkModule bench : benchList) {
            LOG.info("Creating " + bench.getWorkloadConfiguration().getTerminals() + " virtual terminals (threads)...");
